...
def test_create_review_success(mock_supabase, mock_auth_user, sample_contract, sample_review_data):
    ...
    mock_supabase.table.return_value.select.return_value.eq.return_value.execute.return_value.data = []  # Nenhuma review existente
    ...
    mock_supabase.table.return_value.insert.return_value.execute.return_value.data = [created_review]
...
def test_create_review_contract_not_found(mock_supabase, mock_auth_user, sample_review_data):
...
def test_create_review_not_client(mock_supabase, mock_auth_user, sample_contract, sample_review_data):
...
def test_create_review_contract_not_closed(mock_supabase, mock_auth_user, sample_contract, sample_review_data):
...
def test_create_review_already_exists(mock_supabase, mock_auth_user, sample_contract, sample_review_data):
    ...
    mock_supabase.table.return_value.select.return_value.eq.return_value.execute.return_value.data = [existing_review]
...
def test_algorithm_integration_review_score():
    ...
    from backend.algoritmo_match import FeatureCalculator, Lawyer, Case, KPI
    import numpy as np
