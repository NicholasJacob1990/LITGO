...
AUTH_HEADER = {"Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ0ZXN0X3VzZXIifQ.fake_signature"}
...
async def test_full_pipeline_e2e():
    ...
    # A implementação completa requer um ambiente de teste com DB, Redis, e dados semeados.
    assert True 