...
export default function ContractCard({
  ...
  const canSign = user && contractsService.canBeSignedBy(contract, user.id);
  const statusColor = contractsService.getStatusColor(contract.status);
  const statusText = contractsService.getStatusText(contract.status);
